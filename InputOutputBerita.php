...
<?php
  ...
  if(isset($_POST['Simpan']))
  {
    ...
    mysqli_query($connection, "insert into Berita values ('$beritaID','$Judul','$Keterangan')");
		    ...
		    <div class="col-sm-10">
		      ...
		      <form method="POST">
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="beritaID" name="beritaID" placeholder="Kode Berita" maxlength="4">
		          </div>
		        </div>
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="Keterangan" name="Keterangan" placeholder="Keterangan Berita">
		          </div>
		        </div>
