...
<?php
  ...
  if(isset($_POST['Edit'])) //edit
  {
    ...
    mysqli_query($connection, "update Penginapan set namaPenginapan = '$namaPenginapan', Alamat = '$Alamat' WHERE penginapanID= '$penginapanID'") ;
   header("location:InputOutputPenginapan.php");
  }
  // u/ menampilkan data pada form edit
  $kodePenginapan = $_GET["ubah"];
  $editPenginapan = mysqli_query($connection, "SELECT * FROM Penginapan WHERE penginapanID = '$kodePenginapan'");
  $rowEdit = mysqli_fetch_array($editPenginapan);
		    ...
		    <div class="col-sm-10">
		      ...
		      <form method="POST">
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="penginapanID" name="penginapanID" value="<?php echo $rowEdit["penginapanID"];?>" maxlength="4">
		          </div>
		        </div>
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control"  name="namaPenginapan" id="namaPenginapan" value="<?php echo $rowEdit["namaPenginapan"];?>">
		          </div>
		        </div>
