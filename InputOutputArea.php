...
<?php
  ...
  if(isset($_POST['Simpan']))
  {
    ...
    mysqli_query($connection, "insert into area values ('$areaID','$areaNama','$areaWilayah','$areaKeterangan','$provinsiID')");
		    ...
		    <div class="col-sm-10">
		      ...
		      <form method="POST">
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="areaID" name="areaID" placeholder="Kode area" maxlength="4">
		          </div>
		        </div>
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="areaNama" name="areaNama" placeholder="Nama area">
		          </div>
		        </div>
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="areaWilayah" name="areaWilayah" placeholder="Wilayah area">
		          </div>
		        </div>
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="areaKeterangan" name="areaKeterangan" placeholder="Katerangan area">
		          </div>
		        </div>
