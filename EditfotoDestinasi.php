...
<?php
	...
	if(isset($_POST['Ubah']))
	{
		...
		if(empty($nama))
		{
			mysqli_query($connection, "UPDATE fotodestinasi SET fotonama = '$fotonama' , destinasiID = '$destinasiID' where fotoID = '$fotoID' ");
			header("location:InputOutputFoto.php");
		}
		else
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
			...
			mysqli_query($connection, "UPDATE fotodestinasi SET fotonama = '$fotonama' , destinasiID = '$destinasiID' , fotofile = '$nama' where fotoID = '$fotoID' ");
			header("location:InputOutputFoto.php");
		}
	}
		    ...
		    <div class="col-sm-10">
		      ...
		      <form method="POST" enctype="multipart/form-data">
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
		            <input type="text" class="form-control" id="fotonama" name="fotonama" value="<?php echo $rowedit["fotonama"]?>">
		          </div>
		        </div>
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-sm-10">
			          <select class="form-control" id ="destinasiID" name="destinasiID">
			          	<option value="<?php echo $rowedit["destinasiID"]?>" ><?php echo $rowedit['destinasiID'] ?> <?php echo $rowedit2['destinasinama']?>
